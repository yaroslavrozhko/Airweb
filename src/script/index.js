...
let structuredData = {
  ...
  async function loadData() {
    ...
    const months = { "2025-01": "January", "2025-02": "February", "2025-03": "March" };
  ...
  function setupFilters() {
    ...
    regionSelect.addEventListener("change", () => {
      ...
      const cities = region ? Object.keys(structuredData[month][region] || {}) : [];
    ...
    document.getElementById("show").addEventListener("click", () => {
        ...
        if (date) {
          ...
          values = labels.map(day => {
            ...
            const avg = dayEntries.reduce((sum, e) => sum + e.aqi, 0) / dayEntries.length;
